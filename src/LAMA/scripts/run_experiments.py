...
def run_experiments(
    ...
    for relation in relations:
        ...
        PARAMETERS = {
            ...
            "common_vocab_filename": "pre-trained_language_models/common_vocab_cased.txt" if input_param["cased"] else "pre-trained_language_models/common_vocab_lowercased.txt",
            "template": "",
            ...
            "lowercase": not input_param.get("cased", False),
